...
if ( is_singular( 'attachment' ) ) {
	...
	the_post_navigation( array(
		'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'veterinary-pet-care' ) . '</span> ' .
			'<span class="screen-reader-text">' . __( 'Next post:', 'veterinary-pet-care' ) . '</span> ' .
			'<span class="post-title">%title</span>',
		'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'veterinary-pet-care' ) . '</span> ' .
