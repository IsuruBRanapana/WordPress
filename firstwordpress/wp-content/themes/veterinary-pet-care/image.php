                            ...
                            <div class="entry-content">
                                ...
                                <div class="entry-attachment">
                                    <div class="attachment">
                                        <?php veterinary_pet_care_the_attached_image(); ?>
                                    </div>
                                ...
                                <?php
                                    the_content();
                                    wp_link_pages( array(
                                        'before' => '<div class="page-links">' . __( 'Pages:', 'veterinary-pet-care' ),
                                        'after'  => '</div>',
                                    ) );
                                ?>
                            </div>    
                            <?php edit_post_link( __( 'Edit', 'veterinary-pet-care' ), '<footer class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                        </article>    
                        <?php
