...
?>
	...
	<footer id="colophon"  class="site-footer" role="contentinfo">
		...
		<div class="site-info">
			...
			<?php if (get_theme_mod('footer_copyright')) { echo get_theme_mod('footer_copyright'); } else { ?>
		...
		<?php if(get_theme_mod('my_holidayad_bottom')) { ?>
			<div class="ads-footer">
				<a href="<?php echo get_theme_mod('my_holidayad_bottom_url'); ?>">
					<img src="<?php echo get_theme_mod('my_holidayad_bottom'); ?>" alt="banner-top">
				</a>
			</div>
		<?php } ?>	<!-- .ads header -->	
...
<?php if (get_theme_mod( 'my_holidayphone_number' )) { ?>
			<div class="mcn-footer">
				<a href="tel:[<?php echo get_theme_mod('my_holidayphone_number'); ?>]">
					<img alt="phone" src="<?php echo get_template_directory_uri() . '/images/phone9.png'; ?>">
				</a>
			</div>
<?php } ?>	
<?php wp_footer(); ?>
